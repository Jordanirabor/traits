...
const enneagramTypes = [
  {
    ...
    description: 'Principled, purposeful, self-controlled, perfectionistic',
  },
  {
    value: '2',
    label: 'Type 2: The Helper',
    description: 'Generous, demonstrative, people-pleasing, possessive',
  },
  {
    value: '3',
    label: 'Type 3: The Achiever',
    description: 'Adaptable, excelling, driven, image-conscious',
  },
  {
    value: '4',
  ...
  },
  {
    ...
    description: 'Perceptive, innovative, isolated, detached',
  },
  {
    value: '6',
  ...
  },
  {
    ...
    description: 'Spontaneous, versatile, scattered, acquisitive',
  },
  {
    value: '8',
  ...
  },
  {
    ...
    description: 'Receptive, reassuring, complacent, resigned',
  },
];
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <p className="text-sm text-muted-foreground flex-1">
          The Enneagram describes nine personality types, each with distinct
          motivations, fears, and behaviors.
        </p>
        <Button
          variant="outline"
          size="sm"
      ...
      <div>
        ...
        <Select
          ...
          onValueChange={(value) => onUpdate({ enneagram: value })}
        >
        ...
        <div>
          ...
          <div className="p-4 rounded-lg border-2 border-primary/20 bg-primary/5">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              {
                enneagramTypes.find((t) => t.value === data.enneagram)
                  ?.description
              }
            </p>
          </div>
