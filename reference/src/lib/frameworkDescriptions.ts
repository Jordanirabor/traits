export const getFrameworkDescription = (framework: string, value: any): string => {
  switch (framework) {
    case 'bigFive':
    ...
    case 'mbti':
      ...
      return mbtiDescriptions[value as string] || 'MBTI categorizes personality into 16 types based on preferences in four dimensions.';
    
    case 'attachmentStyle':
      const attachmentDescriptions: Record<string, string> = {
        'secure': 'Secure attachment style indicates you\'re comfortable with intimacy and independence. You trust others easily, communicate openly, and handle relationship challenges with confidence. This healthy attachment pattern stems from consistent, responsive caregiving.',
        'anxious': 'Anxious attachment style means you deeply value closeness but often worry about relationships. You may seek reassurance frequently and fear abandonment. This pattern can develop from inconsistent caregiving but is changeable with awareness and practice.',
        'avoidant': 'Avoidant attachment style indicates you highly value independence and may feel uncomfortable with too much closeness. You prefer self-reliance and may withdraw when relationships feel demanding. Understanding this pattern is the first step toward more secure relating.',
        'fearful': 'Fearful-avoidant attachment (also called disorganized) involves conflicting desires for closeness and distance. You may want intimacy but fear getting hurt. This pattern often stems from early relationship trauma but can heal with support and self-awareness.',
      };
      return attachmentDescriptions[value as string] || 'Attachment style describes how you form emotional bonds in relationships.';
    ...
    case 'enneagram':
      ...
      return enneagramDescriptions[value as string] || 'The Enneagram describes nine interconnected personality types, each with unique motivations, fears, and growth paths.';
    
    case 'humanDesign':
      const humanDesignDescriptions: Record<string, string> = {
        'manifestor': 'Manifestors are natural initiators who impact others with their energy. You\'re designed to start things without waiting for permission. Your strategy is to inform others before acting to reduce resistance.',
        'generator': 'Generators have sustainable life force energy for work they love. You\'re designed to respond to opportunities rather than initiate. Your satisfaction comes from doing what lights you up.',
        'manifesting-generator': 'Manifesting Generators are multi-passionate, efficient doers who can juggle multiple projects. You combine Generator\'s sustained energy with Manifestor\'s initiating power. Follow your excitement and inform before acting.',
        'projector': 'Projectors are natural guides who see systems and people clearly. You\'re designed to wait for recognition and invitation before sharing your wisdom. Your gift is directing others\' energy effectively.',
        'reflector': 'Reflectors are rare mirrors of community health. You\'re deeply sensitive to your environment and people around you. Your decision-making strategy is to wait a lunar cycle (28 days) for clarity.',
      };
      return humanDesignDescriptions[value as string] || 'Human Design combines astrology, I Ching, Kabbalah, and chakras to describe your energetic blueprint.';
