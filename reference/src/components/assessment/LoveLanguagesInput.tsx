...
const allLoveLanguages = [
  { value: "words", label: "Words of Affirmation", description: "Verbal expressions of love and appreciation" },
  { value: "quality", label: "Quality Time", description: "Undivided attention and meaningful activities" },
  { value: "gifts", label: "Receiving Gifts", description: "Thoughtful presents and tokens of affection" },
  { value: "service", label: "Acts of Service", description: "Helpful actions that make life easier" },
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <p className="text-sm text-muted-foreground flex-1">
          Love languages describe how you prefer to give and receive affection. Drag to rank them in order of importance (most important at the top).
        </p>
        <Button
          variant="outline"
          size="sm"
      ...
      <div>
        <Label className="text-base font-semibold mb-3 block">Rank Your Love Languages</Label>
        <DndContext
          sensors={sensors}
          ...
          >
            <div className="space-y-3">
              {selected.map((value, index) => {
                const language = allLoveLanguages.find(l => l.value === value);
